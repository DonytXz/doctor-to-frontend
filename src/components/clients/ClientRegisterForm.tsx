      ...
      >
        <>
          ...
          <form>
            <Grid container spacing={3} mb={3}>
              <Grid item lg={6} md={12} sm={12}>
                ...
                <CustomFormLabel htmlFor="curp-text">Curp</CustomFormLabel>
                <CustomTextField id="curp-text" variant="outlined" fullWidth />
                ...
                <CustomTextField
                  ...
                  fullWidth
                />
                <CustomFormLabel htmlFor="blodType-text">
                  Blod Type
                </CustomFormLabel>
                <CustomTextField
                  id="blodType-text"
              ...
              <Grid item lg={6} md={12} sm={12}>
                ...
                />
                <CustomFormLabel htmlFor="curp-text">
                  Marital Status
                </CustomFormLabel>
                <CustomSelect
          ...
          <Grid item lg={12} md={12} sm={12} xs={12}>
            ...
            <CustomTextField id="email-text" variant="outlined" fullWidth />
            <CustomFormLabel htmlFor="phone-text">Phone Number</CustomFormLabel>
            <CustomTextField id="phone-text" variant="outlined" fullWidth />
